...
export class MOLegend extends MOSubscriber {
    ...
    categoryTitle={ base:'GIS 관망도', 
        risk:'리스크맵', leak:'누수예상지점', 
        public:'공공서비스', pipnet:'관망해석결과', 
    ...
    update(publisherID){
        ...
        if(publisher){
            ...
            // document.querySelector('.pop_leg_close').addEventListener('click',function(){})
        }
    }
    //🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨🟨
    ...
    * @returns {Map<string,Array>}*/
    ...
    /** 범례 닫기 버튼 
     * @returns {string}*/
    legend_close = ()=> `<a id="pop_legend_close">❌</a>`;
}   

/* 전형적인 범례 div 형태
<div id="pop_legend" class="pop_legend_wrap"> 🟩🟩🟩🟩🟩🟩🟩범례 target-Element🟩🟩🟩
    <div class="pop_title" tabindex="0">누수점</div> 🟦🟦🟦🟦범례 대 제목🟦
