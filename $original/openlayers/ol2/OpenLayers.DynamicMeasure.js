...
OpenLayers.Control.DynamicMeasure = OpenLayers.Class(
    ...
    initialize: function(handler, options) {
        ...
        if (options.drawingLayer) {
            ...
            if (sketchStyle) {
                options.handlerOptions.layerOptions = OpenLayers.Util.applyDefaults(
     ...
     * 170919 wjgong - 측정 취소 시 타는 함수로서 layer initailize 기능을 담고있다. (이동버튼을 눌러도, 측정기능 후 취소하는 기능이므로 이 함수가 실행됨)
     */
