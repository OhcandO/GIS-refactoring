(function (root, factory) {
	...
	var factor = 131072;
	for (var i = 0; i < 25; i++) {
		scales.push((1.0 / factor * Math.pow(2, i)));
	}
	...
	L.Proj.CRS.Daum = new L.Proj.CRS(
		...
		'+proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=500000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs',
		{
			...
			// YJS: daum 맵을 base로 쓸 때 필요한데 아직 안됨
			//,crs.projection.bounds = bounds;
			,scales: scales
		}
	);
	
	L.Proj.CRS.Daum.projection.bounds = L.bounds([-30000-Math.pow(2,19)*4, -60000], [-30000+Math.pow(2,19)*5, -60000+Math.pow(2,19)*5]);
	...
	L.Proj.CRS.Naver.projection.bounds = L.bounds([90112, 1192896], [1990673, 2761664]);
