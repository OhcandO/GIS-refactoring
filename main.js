...
mainMap.setSelectCallback((feature,layer)=>{
    ...
    if(layer){
        console.log(`선택된 레이어 분류는 : ${layer.get('LAYER_PURPOSE_CATEGORY')} 임`);
    }
})
